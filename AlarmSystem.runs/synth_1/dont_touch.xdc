...
# IP: bd/system/ip/system_PmodOLED_0_0/system_PmodOLED_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_PmodOLED_0_0 || ORIG_REF_NAME==system_PmodOLED_0_0} -quiet] -quiet

# IP: bd/system/ip/system_PmodRTCC_0_0/system_PmodRTCC_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_PmodRTCC_0_0 || ORIG_REF_NAME==system_PmodRTCC_0_0} -quiet] -quiet
