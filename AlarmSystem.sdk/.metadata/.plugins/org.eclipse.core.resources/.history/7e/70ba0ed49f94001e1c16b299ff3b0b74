...
//
////THIS IS A TEST TO KNOW IF FILES WON"T BE SAVED
...
//  ExceptionInit();
//
////   OLED_DisplayMsg("Init done!", 0,0);
////   OLED_DisplayMsg("Hello", 0,1);
//
//  //CLOCK:
//  //init Clock
...
//  OLED_DisplayMsg(timeBuffer,0,0);
////   xil_printf(dateBuffer);
